 ...
 * @usage
 * ```js
 * var easyshop = angular.module('reallyCoolApp', ['ionic']);
 *
 * easyshop.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('easyshop', ['ionic'])
 ...
 *
 * ```
 * angular.module('easyshop', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('easyshop', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
