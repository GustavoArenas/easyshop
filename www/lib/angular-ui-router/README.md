...
```html
<!doctype html>
<html ng-app="easyshop">
<head>
    <script src="//ajax.googleapis.com/ajax/libs/angularjs/1.1.5/angular.min.js"></script>
    <script src="js/angular-ui-router.min.js"></script>
    <script>
        var easyshop = angular.module('easyshop', ['ui.router']);
        // For Component users, it should look like this:
        // var easyshop = angular.module('easyshop', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
easyshop.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
easyshop.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
